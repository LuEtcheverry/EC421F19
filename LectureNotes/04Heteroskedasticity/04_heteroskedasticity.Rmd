...
First assignment! .hi[Due on Sunday. Don't wait.]
...
library(xaringan)
decktape("04_heteroskedasticity.html", "04_heteroskedasticity.pdf", args = "--chrome-arg=--allow-file-access-from-files", docker = FALSE)
```
