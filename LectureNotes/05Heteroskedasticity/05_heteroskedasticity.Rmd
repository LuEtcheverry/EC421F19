...
p_load(
  ...
  kableExtra,
  dplyr, magrittr, knitr, parallel, future.apply
)
# Define pink color
red_pink <- "#e64173"
grey_light <- "grey70"
...
# Notes directory
dir_slides <- "~/Dropbox/Teaching/EC 421 F19/EC421F19_private/LectureNotes/05Heteroskedasticity/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
set.seed(1234)
# The simulation
sim_df <- future_lapply(X = 1:n_iter, FUN = function(i, size) {
  # Generate data
  sample_df <- tibble(
...
system("decktape remark 05_heteroskedasticity.html 03_heteroskedasticity.pdf --chrome-arg=--allow-file-access-from-files")
```
