...
- You will get at least 2pts for ansewing the quiz 
...
# Calculate y1 = 3 + x1 - x3^2 + 2 x5 + error
fun_dt[, y1 := 3 + x1 - x3^2 + 2 * x5 + rnorm(100)]
# Calculate y2 = 1 + x2 + x6 + x8 + error
fun_dt[, y2 := 1 + x2 + x6 + x8 + cumsum(rnorm(100))]
...
pagedown::chrome_print("09_nonstationarity.Rmd")
```
