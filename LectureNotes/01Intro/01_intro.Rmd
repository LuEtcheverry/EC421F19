...
We want to estimate/test the relationship $\text{GPA}=f(H, \text{SAT}, \text{PCT})$.
...
3\. .mono[R] is very __flexible and powerful__—adaptable to nearly any task, _e.g._, 'metrics, spatial data analysis, machine learning, web scraping, data cleaning, website building, teaching. My website and these notes all came out of .mono[R].
...
#library(xaringan)
#decktape("01_intro.html", "01_intro.pdf", args = "--chrome-arg=--allow-file-access-from-files", docker = FALSE)
```
