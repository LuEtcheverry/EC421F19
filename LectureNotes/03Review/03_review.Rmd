...
library(pacman)
p_load(broom, latex2exp, ggplot2, ggthemes, ggforce, viridis, dplyr, magrittr, knitr, parallel, future.apply)
# Notes directory
dir_slides <- "~/Dropbox/Teaching/EC 421 F19/EC421F19_private/LectureNotes/03Review/"
# Knitr options
opts_chunk$set(
  comment = "#>",
  fig.align = "center",
...
I posted **first assignment**. Due 10/13.
...
r_df <- future_lapply(X = 1:(1e3-1), FUN = function(i){
